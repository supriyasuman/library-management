                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="images/publisher.jpg" />
                                </center>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"></asp:GridView> 
                            </div>
                        </div>
